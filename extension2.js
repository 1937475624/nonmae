...
game.saveConfig('联机包_version','1.83');
lib.config.联机包_version='1.83';
game.it=function(){
};
...
var str="https://guishenyi.coding.net/p/coding-code-guide/d/noname/git/raw/master/";
if(!listsx){
var lists=[];
if(bool!==false){
...
game.download('https://guishenyi.coding.net/p/coding-code-guide/d/noname/git/raw/master/updates.js','extension/MCBE命令助手包/updates.js',function(){
var url=lib.assetURL+"extension/MCBE命令助手包";
lib.init.js(url,['updates'],function(){
window.func_Gs(lib,game,ui,get,ai,_status);
});
},function(){});
